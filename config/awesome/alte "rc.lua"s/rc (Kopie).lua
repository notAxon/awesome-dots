...
--              {description = "open a terminal", group = "launcher"}),
   ...
   -- awful.util.spawn("rofi -show window") end,
    ...
    awful.util.spawn("alacritty") end,
              {description = "alacritty", group = "launcher"}),
...
awful.rules.rules = {
    ...
    -- Add titlebars to normal clients and dialogs HIER DRUNTER 3 ZEILEN UNKOMMENTIEREN UM TITLEBAR ZU AKTIVIEREN
...
awful.spawn.with_shell("~/.config/arandr/default-layout.sh")
awful.spawn.with_shell("nitrogen --restore")
--awful.spawn.with_shell("/home/axon/.config/polybar/launch.sh")

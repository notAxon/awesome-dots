...
awful.key({ modkey, "Shift" },            "s",     function ()
   ...
   -- awful.util.spawn("rofi -show window") end,
    ...
    awful.util.spawn("./.config/polybar/launch.sh") end,
...
local alacritty_scratch = bling.module.scratchpad {
...
--awful.spawn.with_shell("~/.config/polybar/launchMultiple.sh")
awful.spawn.with_shell("~/.config/polybar/launch-bottom.sh")

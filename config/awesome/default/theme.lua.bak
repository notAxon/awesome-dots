...
--wibar-related stuff from here
theme.layout_cornernw = "~/.config/awesome/icons/checkbox-blank-outline.png"
theme.layout_floating = "~/.config/awesome/icons/checkbox-multiple-blank-outline.png"
